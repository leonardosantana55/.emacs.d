;;; my-modus-vivendi-theme.el --- Elegant, highly legible theme with a black background -*- lexical-binding:t -*-
...
7:1 (WCAG AAA standard)."
  ...
  (defconst my-modus-vivendi-palette
    '(
;;; Basic values
...
;;;; Heading mappings
    ...
    "The entire palette of the `my-modus-vivendi' theme.
...
exists in the palette and is associated with a HEX-VALUE.")
  ...
  (defcustom my-modus-vivendi-palette-user nil
    "Like the `my-modus-vivendi--palette' for user-defined entries.
...
`my-modus-vivendi--palette-overrides')."
    :group 'modus-themes
  ...
  (defcustom my-modus-vivendi-palette-overrides nil
    "Overrides for `my-modus-vivendi-palette'.
...
represents."
  ...
  (modus-themes-theme my-modus-vivendi
                      my-modus-vivendi-palette
                      my-modus-vivendi-palette-overrides)

  (provide-theme 'my-modus-vivendi))

;;; my-modus-vivendi-theme.el ends here
